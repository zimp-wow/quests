...
-- items: 17256, 22587, 22586, 22585, 22589, 22588, 22583, 22584, 9116, 9117, 9118, 9119, 9120
...
function event_say(e)
	...
	elseif(e.message:findi("important components")) then
		...
		e.other:SummonItem(17256); -- Item: Tinkered Sewing Kit
		e.other:Ding();
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 9116, item2 = 9117, item3 = 9118, item4 = 9119})) then
		...
		e.other:SummonItem(9120); -- Item: Spellbook of the Eldritch Initiate
		e.other:Faction(245,10,0); -- Faction: Eldritch Collective
		e.other:Faction(238,-15,0); -- Faction: Dark Reflection
		e.other:Faction(239,-15,0); -- Faction: The Dead
