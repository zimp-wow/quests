...
function event_say(e)
	...
	elseif(qglobals["ask_minion_dead"] ~= nil and e.message:findi("demise") ) then
		...
		e.other:SummonItem(15778); -- Item: Sentience of Elements
	elseif(e.message:findi("hail")) then
		e.self:Say("What do you want?! Foolish "..e.other:GetRaceName() ..", I am in no mood to treat with beggars. I have half a mind to turn my pet here loose on you! Well, don't keep me waiting, state your business or be off with you!");
