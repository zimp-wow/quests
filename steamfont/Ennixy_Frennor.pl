...
sub EVENT_SAY {
  ...
  if ($text=~/hate be my guide/i && !$npc->GetBucket("Crusader_Swiftmoon")) {
    ...
    quest::unique_spawn(56150,0,0,-836,1385,-110,256); #Crusader Swiftmoon
    $npc->SetBucket("Crusader_Swiftmoon", 1, "10m");
  }
  if($text=~/wormwood/i) {
