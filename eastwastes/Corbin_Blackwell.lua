...
function event_waypoint_arrive(e) -- this deviates slightly from the original version. The orcs and giants spawn in separate waves, but they spawn on top of him preventing kiting/pulling away
    if e.wp == 1 then
        ...
        eq.spawn2(116553, 0, 0, -2027, 149, 150, 114);  -- NPC: Ry`Gorr Basher
        eq.spawn2(116553, 0, 0, -2027, 159, 150, 114);  -- NPC: Ry`Gorr Basher
        eq.spawn2(116553, 0, 0, -2037, 159, 150, 114);  -- NPC: Ry`Gorr Basher
        eq.spawn2(116553, 0, 0, -2037, 149, 150, 114);  -- NPC: Ry`Gorr Basher
        eq.signal(116553, 1, 600);                      -- NPC: Ry`Gorr Basher Attack Corbin
    elseif e.wp == 2 then
        e.self:Say("Uh oh, looks like they were tipped off somehow... I hope you can handle them.");
        eq.spawn2(116569, 0, 0, -2819, -296, 149, 80);  -- NPC: Commander Bahreck
        eq.spawn2(116548, 0, 0, -2825, -286, 148, 80);  -- NPC: Kromrif Soldier
        eq.spawn2(116548, 0, 0, -2831, -276, 150, 80);  -- NPC: Kromrif Soldier
        eq.spawn2(116548, 0, 0, -2813, -306, 151, 80);  -- NPC: Kromrif Soldier
        eq.spawn2(116548, 0, 0, -2807, -316, 151, 80);  -- NPC: Kromrif Soldier
        eq.signal(116548, 1, 600);                      -- NPC: Kromrif Soldier Attack Corbin
    elseif e.wp == 4 then
