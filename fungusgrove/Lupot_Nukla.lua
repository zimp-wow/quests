...
function event_say(e)
	...
	elseif(e.message:findi("protected") and qglobals["shaman_epic"] == "10") then
		e.self:Say("When Undari was a young, peaceful Taelosian, she chose to defy the trusik -- the religious fanatics -- who called for the hurt and torture of her people. You see, once, all Taelosians lived in Nihilia, but something changed. One sly and corrupt Taelosian found a path to power and preached about a false god. He convinced many to follow him and they became the [" .. eq.say_link("trusik") .. "] who worshipped Trushar, an ocean god. They would torture those who didn't believe as they did.");
	elseif(e.message:findi("trusik") and qglobals["shaman_epic"] == "10") then
		e.self:Say("The trusik were eventually forced into exile in the temples of the highest mountains. The Taelosians who resisted the beliefs and rhetoric of the trusik became known as the nihil -- and Undari was one of them. She believed in nature, the ebb and flow of a greater consciousness, and that if she kept her hopes high, she would overcome the horror of the zealots. And she [" .. eq.say_link("prevailed") .. "].");
	elseif(e.message:findi("prevailed") and qglobals["shaman_epic"] == "10") then
		e.self:Say("Undari's unwavering regard and respect for nature gained the attention of the spirit world, particularly that of the Spirit of Perseverance. The spirit would watch over her and time after time would [" .. eq.say_link("see") .. "] her bring more of her kind into spiritual awareness.");
	elseif(e.message:findi("see") and qglobals["shaman_epic"] == "10") then
		e.self:Say("The spirit saw that Undari always wore a beautiful necklace made of polished stone that her mother gave her. Her mother was taken by the trusik long ago because she refused to accept Trushar into her heart. She was taken down to the shores of Natimbi and shackled, sentenced to hang over the sea until she died. It was then that the spirit chose to bestow a [" .. eq.say_link("great gift") .. "] on Undari, as thanks and reward for her steadfast faith in the spirit world.");
	elseif(e.message:findi("great gift") and qglobals["shaman_epic"] == "10") then
		e.self:Say("'The spirit appeared before Undari, who was overcome with humility. The spirit cast a mighty spell and it rained upon Undari and was imbued into her necklace. The necklace would henceforth protect the young Undari from those who held dark beliefs and would try to corrupt her mind. Now you see why we had need of this necklace. But we are not done yet. We still need to make a [" .. eq.say_link("talisman") .. "].");
	elseif(e.message:findi("talisman") and qglobals["shaman_epic"] == "10") then
