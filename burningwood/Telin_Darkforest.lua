...
function event_trade(e)
	...
	if(fac < 4) then
		if(item_lib.check_turn_in(e.trade, {item1 = 20447})) then
			...
			e.other:Ding();
			e.other:SummonFixedItem(20448); -- Item: Worn Dark Metal Coin
		elseif(item_lib.check_turn_in(e.trade, {item1 = 20468})) then
			...
			e.other:SummonFixedItem(20477); -- Item: Ancient Longsword
		elseif(item_lib.check_turn_in(e.trade, {item1 = 20481})) then
			...
			e.other:Ding();
			e.other:SummonFixedItem(20481); -- Item: Refined Ancient Sword
