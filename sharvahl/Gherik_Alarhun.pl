...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 3648 => 3)) {
    ...
    quest::summonitem(17235); # Item: Claymixing Bowl
    quest::summonitem(3651); # Item: Reusable Jharin Bowl Sketch
  }
  if (plugin::check_handin(\%itemcount, 3653 => 1)) {
    ...
    quest::summonitem(3653); # Item: Unfired Bowl of the Jharin
  }
