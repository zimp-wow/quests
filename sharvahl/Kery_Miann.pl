# items: 5571, 17237, 5572, 5581, 3673, 3674, 5574, 5575, 5573, 5577, 17610, 5579, 5580
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 5571 => 1)) {
    ...
    quest::summonitem(17237); # Item: Stitching Pack
    quest::summonitem(5572); # Item: Small Stone Blade
  }
    ...
    quest::summonitem(5574); # Item: Reinforced Khati Sha Claw
    quest::summonitem(5575); # Item: Reinforced Khati Sha Claw
    quest::summonitem(5573); # Item: Folded Note
    quest::exp(2500);
  }
    ...
    quest::summonitem(17610); # Item: Carved Wooden Box
    quest::exp(1000);
