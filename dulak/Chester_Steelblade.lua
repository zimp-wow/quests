...
function event_say(e)
    if(e.message:findi("Hail")) then
        e.other:Message(MT.White, "A soft glow fills the cavern as an ethereal form begins to form in front of you. The stern face of a middle aged Erudite forms from the swirling mists and begins to speak to you. 'Find the key to Brokenskull and free me from my torment.'");
    end
end
...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.trade, {item1 = 59028}) and e.other:HasClass(Class.PALADIN)) then -- Glowing Black Medallion
