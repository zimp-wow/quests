...
function pop_flags.options(e)
	if e.self:GetGM() then
		...
		elseif e.message:findi("PoJ flag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Justice flags added.");
		elseif e.message:findi("PoJ deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Justice flags have been deleted.");
			
		--Plane of Storms
		elseif e.message:findi("PoS options") then
			e.self:Message(MT.BrightBlue,"Plane of Storms flagging options are: [" .. eq.say_link("PoS flag all",false,"flag all") .. "], [" .. eq.say_link("PoS deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting the flag all option you will receive all flags required to enter Torden, Bastion of Thunder.");
		elseif e.message:findi("PoS flag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Storms flags added.");
		elseif e.message:findi("PoS deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Storms flags have been deleted.");
		
		--Bastion of Thunder
		elseif e.message:findi("BoT options") then
			e.self:Message(MT.BrightBlue,"Bastion of Thunder flagging options are: [" .. eq.say_link("BoT flag all",false,"flag all") .. "], [" .. eq.say_link("BoT deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting the flag all option you will receive the flag from Karana and all required pre-flags.");
		elseif e.message:findi("BoT flag all") then
			...
			e.self:Message(MT.Cyan,"All of Bastion of Thunder flags added.");
		elseif e.message:findi("BoT deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Bastion of Thunder flags have been deleted.");
		
		--Plane of Valor
		elseif e.message:findi("PoV options") then
			e.self:Message(MT.BrightBlue,"Plane of Valor flagging options are: [" .. eq.say_link("PoV flag all",false,"flag all") .. "], [" .. eq.say_link("PoV deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting the flag all option you will receive all flags required to enter The Halls of Honor.");
		elseif e.message:findi("PoV flag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Valor flags added.");
		elseif e.message:findi("PoV deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Valor flags have been deleted.");
		
		--Halls of Honor
		elseif e.message:findi("HoHa options") then
			e.self:Message(MT.BrightBlue,"Halls of Honor flagging options are: [" .. eq.say_link("HoHa flag all",false,"flag all") .. "], [" .. eq.say_link("HoHa deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting the flag all option you will receive all flags required to enter The Temple of Marr (Halls of Honor B).");
		elseif e.message:findi("HoHa flag all") then
			...
			e.self:Message(MT.Cyan,"All of Halls of Honor flags added.");
		elseif e.message:findi("HoHa deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Halls of Honor flags have been deleted.");
		
		--Plane of Nightmare
			elseif e.message:findi("PoN options") then
			e.self:Message(MT.BrightBlue,"Plane of Nightmare flagging options are: [" .. eq.say_link("PoN flag all",false,"flag all") .. "], [" .. eq.say_link("PoN deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option you will receive all flags required to enter the Lair of Terris Thule.");
		elseif e.message:findi("PoN flag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Nightmare flags added.");
		elseif e.message:findi("PoN deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Nightmare flags have been deleted.");
		
		--Plane of Disease
		elseif e.message:findi("PoD options") then
			e.self:Message(MT.BrightBlue,"Plane of Disease flagging options are: [" .. eq.say_link("PoD flag all",false,"flag all") .. "], [" .. eq.say_link("PoD deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option you will receive all flags required to enter the Ruins of Lxanvom(The Crypt of Decay).");
		elseif e.message:findi("PoD flag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Disease flags added.");
		elseif e.message:findi("PoD deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Disease flags have been deleted.");
		
		--Plane of Innovation
		elseif e.message:findi("PoI options") then
			e.self:Message(MT.BrightBlue,"Plane of Innovation flagging options are: [" .. eq.say_link("PoI flag all",false,"flag all") .. "], [" .. eq.say_link("PoI deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option you will receive all flags required to enter the Drunder, The Fortress of Zek (potactics).");
		elseif e.message:findi("PoI flag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Innovation flags added.");
		elseif e.message:findi("PoI deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Innovation flags have been deleted.");
		
		--Crypt of Decay
		elseif e.message:findi("CoD options") then
			e.self:Message(MT.BrightBlue,"Crypt of Decay flagging options are: [" .. eq.say_link("CoD flag all",false,"flag all") .. "], [" .. eq.say_link("CoD deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option you will receive all flags required to complete Bertoxx questline (Ready for Plane of Torment if Terris questline is complete).");
		...
		elseif e.message:findi("CoD flag all") then
			...
			e.self:Message(MT.Cyan,"All of Crypt of Decay flags added.");
		...
		elseif e.message:findi("CoD deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Crypt of Decay flags have been deleted.");
		
		--Lair of Terris Thule
		elseif e.message:findi("PoNb options") then
			e.self:Message(MT.BrightBlue,"Plane of Nightmare flagging options are: [" .. eq.say_link("PoNb flag all",false,"flag all") .. "], [" .. eq.say_link("PoNb deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option you will have completed the Terris Thule questline (Ready for Plane of Torment if Bertoxx chain is complete)");
		...
		elseif e.message:findi("PoNb flag all") then
			...
			e.self:Message(MT.Cyan,"All of the Lair of Terris Thule flags added.");
		...
		elseif e.message:findi("PoNb deflag all") then
			...
			e.self:Message(MT.Cyan,"All of the Lair of Terris flags have been deleted.");
		
		--Plane of Torment
		elseif e.message:findi("PoTorment options") then
			e.self:Message(MT.BrightBlue,"Plane of Torment flagging options are: [" .. eq.say_link("PoTorment flag all",false,"flag all") .. "], [" .. eq.say_link("PoTorment deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option you will have completed Plane of Torment questline.");
		...
		elseif e.message:findi("PoTorment flag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Torment flags added.");
		...
		elseif e.message:findi("PoTorment deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Plane of Torment flags have been deleted.");
			
		--Temple of Marr
		elseif e.message:findi("HoHb options") then
			e.self:Message(MT.BrightBlue,"Temple of Marr flagging options are: [" .. eq.say_link("HoHb flag all",false,"flag all") .. "], [" .. eq.say_link("HoHb deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option you will have completed The Temple of Marr questline.");
		...
		elseif e.message:findi("HoHb flag all") then
			...
			e.self:Message(MT.Cyan,"All of Temple of Marr flags added.");
		...
		elseif e.message:findi("HoHb deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Temple of Marr flags have been deleted.");

		--Plane of Tactics
		elseif e.message:findi("PoTactics options") then
			e.self:Message(MT.BrightBlue,"Drunder, Fortress of Zek flagging options are: [" .. eq.say_link("PoTactics flag all",false,"flag all") .. "], [" .. eq.say_link("PoTactics deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option you will have completed the Drunder, Fortress of Zek questline.");
		...
		elseif e.message:findi("PoTactics flag all") then
			...
			e.self:Message(MT.Cyan,"All of Drunder, Fortress of Zek flags added.");
		...
		elseif e.message:findi("PoTactics deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Drunder, Fortress of Zek flags have been deleted.");
		
		--Tower of Solusek Ro
		elseif e.message:findi("SRT options") then
			e.self:Message(MT.BrightBlue,"Tower of Solusek Ro flagging options are: [" .. eq.say_link("SRT flag all",false,"flag all") .. "], [" .. eq.say_link("SRT deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option you will have completed the Tower of Solusek Ro and will be flagged for Plane of Fire.");
		...
		elseif e.message:findi("SRT flag all") then
			...
			e.self:Message(MT.Cyan,"All of Tower of Solusek Ro flags added.");
		...
		elseif e.message:findi("SRT deflag all") then
			...
			e.self:Message(MT.Cyan,"All of Tower of Solusek Ro flags have been deleted.");
		
		--Elemental Planes
		elseif e.message:findi("EP options") then
			e.self:Message(MT.BrightBlue,"Tower of Solusek Ro flagging options are: [" .. eq.say_link("EP flag all",false,"flag all") .. "], [" .. eq.say_link("EP deflag all", false, "deflag all") .. "]" )
			e.self:Message(MT.BrightBlue,"By selecting flag all option provide all flags to grant access to the Elemental Planes (Air, Water, Earth).  Choose SRT options for PoFire.");
		...
		elseif e.message:findi("EP flag all") then
			...
			e.self:Message(MT.Cyan,"All Elemental Planes flags added.");
		...
		elseif e.message:findi("EP deflag all") then
			...
			e.self:Message(MT.Cyan,"All Elemental Planes flags have been deleted.");
		...
		elseif e.message:findi("advanced flag add") then
			e.self:Message(MT.Lime,"Click the flags below to add individually:");
			advanced_flag_listing(e,true)
		
		elseif e.message:findi("advanced flag delete") then
			e.self:Message(MT.Lime,"Click the flags below to delete individually:");
			advanced_flag_listing(e,false)
		elseif e.message:findi("race") then	
			e.self:Message(MT.Lime,tostring(e.self:Race()));
		...
		for k,v in pairs(all_flags) do
			if e.message:findi("setflag " .. v[1]) then
				...
				e.self:Message(MT.Cyan, v[1] .. " flag has been added!");
			elseif e.message:findi("removeflag " .. v[1]) then
				eq.delete_global(tostring(v[2]));
				e.self:Message(MT.Cyan, v[1] .. " flag has been deleted!");
			end
		end
	end
end
...
function advanced_flag_listing(e,option)
	if option then phrase = "setflag" else phrase = "removeflag" end;
	local num = 0;
	for _ in ipairs(all_flags) do 
		
		num = num + 1;
		e.self:Message(MT.Lime,"[" .. eq.say_link(tostring(phrase) .. " " .. all_flags[num][1] ,false, all_flags[num][1]) .. "]");
	end
end
...
function deflagme(e)
	...
	e.self:Message(MT.Cyan,"All PoP flags have been removed.");
end
...
function flagme_all(e)
	...
	e.self:Message(MT.Cyan,"You have been flagged for all zones");
