function event_say(e)
	if e.message:findi("hail") then
		e.self:Say("I greet thee, ".. e.other:GetName() .. ". You will have to pardon my demeanour; I am afraid that I am not in the best of spirits. Recently yet another brother was taken from us by an [evil] unknown through the dark art of mind rending.");
...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 31445, item2 = 31446, item3 = 31443, item4 = 31444})  then
		...
		e.other:SummonItem(1325); -- Item: Wreath of Nature
