...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 31427, item2 = 31430, item3 = 31429, item4 = 31428}) then
	...
	elseif item_lib.check_turn_in(e.trade, {item1 = 31432, item2 = 31434, item3 = 31431, item4 = 31433}) then
		e.self:Say("May Tunare's blessing be upon thee! Here, take this item and use it wisely.");
