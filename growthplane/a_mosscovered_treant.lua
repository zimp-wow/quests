...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 31435,item2 = 31436,item3 = 31437,item4 = 31438}) then
		e.self:Emote("whispers, like wind through the tree tops, as it speaks hushed words to the tree.");
