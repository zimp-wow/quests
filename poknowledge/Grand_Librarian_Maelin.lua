...
function event_say(e)
	...
	elseif(e.other:GetBucket("pop_hohb_marr") >= "1" and 
			e.other:GetBucket("pop_bot_agnarr") >= "1" and 
			e.other:GetBucket("pop_pon_hedge_jezith") >= "1" and 
			e.other:GetBucket("pop_pon_construct") >= "1" and 
			e.other:GetBucket("pop_ponb_terris") >= "1" and 
			e.other:GetBucket("pop_ponb_poxbourne") >= "1" and 
			e.other:GetBucket("pop_pod_alder_fuirstel") >= "1" and 
			e.other:GetBucket("pop_pod_grimmus_planar_projection") >= "1" and 
			e.other:GetBucket("pop_pod_elder_fuirstel") >= "1" and 
			e.other:GetBucket("pop_poj_mavuin") >= "1" and 
			e.other:GetBucket("pop_poj_tribunal") >= "1" and 
			e.other:GetBucket("pop_poj_valor_storms") >= "1" and 
			e.other:GetBucket("pop_pov_aerin_dar") >= "1" and 
			e.other:GetBucket("pop_pos_askr_the_lost") >= "3" and 
			e.other:GetBucket("pop_pos_askr_the_lost_final") >= "1" and 
			e.other:GetBucket("pop_cod_preflag") >= "1" and 
			e.other:GetBucket("pop_cod_bertox") >= "1" and 
			e.other:GetBucket("pop_cod_final") >= "1" and 
			e.other:GetBucket("pop_pot_shadyglade") >= "1" and 
			e.other:GetBucket("pop_pot_saryrn") >= "1" and 
			e.other:GetBucket("pop_pot_saryrn_final") >= "1" and 
			e.other:GetBucket("pop_hoh_faye") >= "1" and 
			e.other:GetBucket("pop_hoh_trell") >= "1" and 
			e.other:GetBucket("pop_hoh_garn") >= "1" and 
	e.other:GetBucket("pop_tactics_ralloz") >= "1") then --Elemental Pre-Flagging
		if(e.message:findi("hail")) then
