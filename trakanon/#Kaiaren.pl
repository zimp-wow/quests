...
sub EVENT_ITEM {
  if(($ulevel >= 46) && (plugin::check_handin(\%itemcount, 1683 => 1))) { #Celestial Fists (Book)
  ...
  elsif(($ulevel >= 46) && (plugin::check_handin(\%itemcount, 1688 => 1, 1689 => 1))) { #Demon Fangs and Book of Celestial Fists
