...
function event_trade(e)
	...
	if stage0 and item_lib.check_turn_in(e.trade, {item1 = 30369}) then -- Item: 9th ring
		...
		stage0 = false;
	elseif stage5 and item_lib.check_turn_in(e.trade, {item1 = 30369, item2 = 1739}) then -- Items: Narandi's Head and 9th ring
		...
		e.other:Faction(406, 50);	-- Faction: Coldain
		e.other:Faction(405, 20);	-- Faction: Dain
		e.other:Faction(419, -80);	-- Faction: Kromrif
		e.other:Faction(448, -40);	-- Faction: Kromzek
		e.other:SummonItem(1741);	-- Item: Shorn head
		e.other:QuestReward(e.self, 0, 0, 0, 0, 30385, 1000000); -- Rewards: 10th ring and big exp hit!
