...
function event_trade(e)
	local item_lib = require("items");
		...
		if(item_lib.check_turn_in(e.trade, {item1 = 25106})) then -- # Handin: Bekerak's New Spear 
			...
			eq.spawn2(118164,0,0,-2776,-3011,255.5,131); -- # Spawn: #an_angry_shardwurm (x:-2776 y:-3011 z:255.5 heading:65.5)
			
		elseif(item_lib.check_turn_in(e.trade, {item1 = 25191})) then -- # Handin: Giant Shard Wurm Tooth
		...
		elseif(item_lib.check_turn_in(e.trade, {item1 = 25266})) then -- # Giant Sack of Supplies
	    ...
	    elseif(item_lib.check_turn_in(e.trade, {item1 = 25269})) then -- # Large Supply Sack for Bekerak
			e.self:Say("I am in your debt, " .. e.other:GetRace() .. ".  These supplies will help our effort to destroy the Coldain.  I wish I had more to give than what I do.'  Bekerak pulls a strange looking totem on a string from one of his pockets and hands it to you.  'May Lord Rallos smile upon you, " .. e.other:GetCleanName() .. ".'");
		    e.other:Faction(189,10); -- # Kromzek
		    e.other:Faction(188,10); -- # Kromrif
		    e.other:Faction(49,-30); -- # Coldain
		    e.other:Faction(42,-30); -- # Claws of Veeshan
