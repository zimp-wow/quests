...
function event_trade(e)
	...
	if(e.other:HasClass(Class.ENCHANTER) or e.other:HasClass(Class.MAGICIAN) or e.other:HasClass(Class.NECROMANCER) or e.other:HasClass(Class.WIZARD)) then
