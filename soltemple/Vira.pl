...
sub EVENT_ITEM {
  if(($itemcount{16544} == 1) && ($itemcount{16543} == 1) && ($itemcount{16538} == 1) && ($itemcount{10032} == 1)) { #Broom, Cyclops Toes, Griffon Feathers, Star Ruby
  ...
  elsif(($itemcount{10035} == 1) && ($itemcount{10014} == 1) && ($itemcount{16545} == 1) && ($itemcount{16539} == 1)) { #Ruby, Gargoyle Eye, Shovel, Hill Giant Toes
  ...
  elsif(($itemcount{16540} == 1) && ($itemcount{16542} == 1) && ($itemcount{10034} == 1) && ($itemcount{16547} == 1)) { #Ice Giant Toes, Mermaid Scale, Sapphire, Stein 
  ...
  elsif(($itemcount{16546} == 1) && ($itemcount{16534} == 1) && ($itemcount{10033} == 1) && ($itemcount{16541} == 1)) { #Torch, Fire Drake Scale, Fire Emerald, Fire Giant Toes
  ...
  elsif(($itemcount{58003} == 1)) { #Vial of Liquid
