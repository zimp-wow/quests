...
sub EVENT_ITEM {
    if (plugin::check_handin(\%itemcount, 10548 => 1, 10549 => 1, 10550 => 1, 6048 => 1)) {
        quest::say("Well done, $name. Now I will craft your Staff of Temperate Flux, as promised.");
        quest::summonitem(6342); # Staff of Temperate Flux
        quest::faction(415, 15);
        quest::faction(416, -15);
        quest::exp(1000);
    } elsif (plugin::check_handin(\%itemcount, 10551 => 1, 6338 => 1, 10557 => 1, 14364 => 1)) {
        quest::say("Well done, $name. Now I will craft your Weeping Wand, as promised.");
        quest::summonitem(6341); # Weeping Wand
        quest::faction(415, 15);
        quest::faction(416, -15);
        quest::exp(1000);
    } elsif (plugin::check_handin(\%itemcount, 10034 => 2, 10000 => 1)) {
        quest::say("Ahh, Genni must have sent you to me. Very well, here is your Lambent Sapphire.");
        quest::summonitem(10119); # Lambent Sapphire
        quest::faction(415, 15);
        quest::faction(416, -15);
        quest::exp(1000);
    }
