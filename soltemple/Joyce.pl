...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 10545 => 1, 10547 => 1, 10034 => 1, 10546 => 1)) {
    quest::say("You have done well. You are truly a powerful magician. Here is your Circlet of Mist.");
    quest::summonitem(2358); # Circlet of Mist
    quest::faction(415, 15);
    quest::faction(416, -15);
  } elsif (plugin::check_handin(\%itemcount, 10539 => 1, 10542 => 1, 10540 => 1, 10541 => 1)) {
    ...
    quest::summonitem(2359); # Clay Bracelet
    quest::faction(415, 15);
    quest::faction(416, -15);
  } elsif (plugin::check_handin(\%itemcount, 10543 => 1, 10026 => 1, 10544 => 1, 2363 => 1)) {
    quest::say("You have done well. You are truly a powerful magician. Here are your Earthen Boots.");
    quest::summonitem(2357); # Earthen Boots
    quest::faction(415, 15);
    quest::faction(416, -15);
  } elsif (plugin::check_handin(\%itemcount, 2361 => 1, 2362 => 1, 15109 => 1, 2360 => 1)) {
    quest::say("You have done well. You are truly a powerful magician. Here is your Robe of the Elements.");
    quest::summonitem(1356); # Robe of the Elements
    quest::faction(415, 15);
    quest::faction(416, -15);
  }
