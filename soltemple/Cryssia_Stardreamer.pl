...
sub EVENT_ITEM {
    if (plugin::check_handin(\%itemcount, 10564 => 1, 10563 => 1, 10128 => 1)) {
        ...
        quest::summonitem(4156); # Lambent Bracers
    } elsif (plugin::check_handin(\%itemcount, 4100 => 1, 10565 => 1, 10118 => 1)) {
        quest::say("Well done. Here is your Lambent Breastplate.");
        quest::summonitem(4154); # Lambent Breastplate
    } elsif (plugin::check_handin(\%itemcount, 10559 => 1, 4099 => 1, 10117 => 1)) {
        quest::say("Well done. Here is your Lambent Helm");
        quest::summonitem(4153); # Lambent Helm
    } elsif (plugin::check_handin(\%itemcount, 4113 => 1, 10560 => 1, 10119 => 1)) {
        quest::say("Well done. Here are your Lambent Vambraces.");
        quest::summonitem(4155); # Lambent Vambraces
    }
