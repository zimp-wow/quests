...
sub EVENT_ITEM {
    if (plugin::check_handin(\%itemcount, 2352 => 1, 2368 => 1, 10558 => 1, 2367 => 1)) {
        quest::say("Well done $name. You truly are a powerful wizard. I have crafted your mask. Take it.");
        quest::summonitem(2366); # Acumen Mask
        quest::faction(415, 15);
        quest::faction(416, -15);
        quest::exp(1000);
    } elsif (plugin::check_handin(\%itemcount, 2332 => 1, 10553 => 1, 10554 => 1, 10555 => 1)) {
        quest::say("Well done $name. You truly are a powerful wizard. I have crafted your cloak. Take it.");
        quest::summonitem(2364); # Runescale Cloak
        quest::faction(415, 15);
        quest::faction(416, -15);
        quest::exp(1000);
    } elsif (plugin::check_handin(\%itemcount, 10035 => 2, 10000 => 1)) {
        quest::say("Okay, here is your Lambent Ruby.");
        quest::summonitem(10118); # Lambent Ruby
        quest::faction(415, 15);
        quest::faction(416, -15);
        quest::exp(1000);
        ...
        quest::summonitem(19048); # Vulcanized Platinum Bar
    }
