...
sub EVENT_SAY {
    ...
    } elsif ($text =~ /galvanized/i || $text =~ /vulcanized/i || $text =~ /magnetized/i) {
...
sub EVENT_ITEM {
    if (plugin::check_handin(\%itemcount, 16507 => 2, 19010 => 1, 19009 => 1)) {
        ...
        quest::summonitem(4925); # Bracers of the Reverent
        ...
        quest::summonitem(6407); # Caduceus of Sacrament
        quest::faction(415, 15);
        quest::faction(416, -15);
        quest::exp(1000);
        ...
        quest::summonitem(4926); # Chestplate of the Constant
        quest::faction(415, 15);
        quest::faction(416, -15);
        quest::exp(1000);
        ...
        quest::summonitem(9427); # Shield of the Devout
        quest::faction(415, 15);
        quest::faction(416, -15);
        quest::exp(1000);
    }
