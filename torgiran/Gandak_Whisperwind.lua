...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.trade, {item1 = 21986})) then -- Medallion of the Emerald warrior
    ...
    elseif(qglobals["Gandak"] == "1" and item_lib.check_turn_in(e.trade, {item1 = 21989, item2 = 21990, item3 = 21991, item4 = 21992})) then -- Global from Pre-Quest -- Items: Insignia of Hatred, Insignia of Slaying, Insignia of the Blackblood, Insignia of Suffering
