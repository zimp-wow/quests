...
function event_say(e)
    ...
    elseif(e.message:findi("frenzy")) then
        ...
        eq.unique_spawn(226099, 0, 0, e.self:GetX(), e.self:GetY(),  e.self:GetZ(),  e.self:GetHeading()); --a_frenzied_luggald_abomination (226099)
        eq.depop();
    elseif(e.message:findi("berserk")) then
        ...
        eq.unique_spawn(226108, 0, 0, e.self:GetX(), e.self:GetY(),  e.self:GetZ(),  e.self:GetHeading()); --a_berserk_luggald_abomination (226108)
        eq.depop();
    elseif(e.message:findi("fury")) then
        ...
        eq.unique_spawn(226107, 0, 0, e.self:GetX(), e.self:GetY(),  e.self:GetZ(),  e.self:GetHeading()); --a_furious_luggald_abomination (226107)
        eq.depop();
    elseif(e.message:findi("rage")) then
        ...
        eq.unique_spawn(226110, 0, 0, e.self:GetX(), e.self:GetY(),  e.self:GetZ(),  e.self:GetHeading()); --an_enraged_luggald_abomination (226110)
        eq.depop();
    end
end
