...
sub EVENT_SAY {
 ...
 if($text =~ /armor/i) {
	quest::emote("Grigdor let's out a gravelly laugh.");
     ...
     quest::summonitem(55375); # Item: Bloodwolf Chain Assembly Kit
 }
 if($text =~ /boots/i) {
    ...
    quest::summonitem(55371); # Item: Bloodwolf Boot Mold
 }
 ...
 if ($text=~/leggings/i) {
   ...
   quest::summonitem(55372); # Item: Bloodwolf Leggings Mold
 }
 ...
 if ($text=~/bracers/i) {
   ...
   quest::summonitem(55369); # Item: Bloodwolf Bracer Mold
 }
 ...
 if ($text=~/gloves/i) {
   ...
   quest::summonitem(55373); # Item: Bloodwolf Gloves Mold
 }
 ...
 if ($text=~/coif/i) {
   ...
   quest::summonitem(55368); # Item: Bloodwolf Coif Mold
 }
 ...
 if ($text=~/gorget/i) {
   ...
   quest::summonitem(55370); # Item: Bloodwolf Gorget Mold
 }
 ...
 if ($text=~/tunic/i) {
   ...
   quest::summonitem(55374); # Item: Bloodwolf Tunic Mold
 }
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 13372 =>1, 51038 =>1 )) {
    ...
    quest::summonitem(55376); # Item: Axe of the Bloodwolf
    quest::ding();
    quest::exp(100);
  }
