...
sub EVENT_SAY {
  ...
  if ($text=~/helm/i) {
    ...
    quest::summonitem(55172); # Item: Da Basher Helm Mold
  }
  if ($text=~/bracers/i) {
  quest::say("To craft Da Basher Bracer, you needs ta find a Crab Spider's Carapace, two Spiderling Silks, and a Malleable Bleeder Skin. Den you needs ta combine dese itemz in yer kit. Den take Da Basher Bracer Material to da forge with dis mold to make yer new bracer.");
    quest::summonitem(55173); # Item: Da Basher Bracer Mold
  }
  if ($text=~/armguards/i) {
    ...
    quest::summonitem(55174); # Item: Da Basher Armguards Mold
  }
  if ($text=~/boots/i) {
    ...
    quest::summonitem(55175); # Item: Da Basher Boots Mold
  }
  if ($text=~/greaves/i) {
    ...
    quest::summonitem(55176); # Item: Da Basher Greaves Mold
  }
  if ($text=~/gauntlets/i) {
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 51038 => 1, 13372 => 1)) {
    quest::summonitem(55186); # Item: Da Basher Sword
    quest::ding();
    quest::exp(100);
  }
