...
function event_trade(e)
	...
	elseif(fac <= 4 and tonumber(qglobals.qeynos_badge5) == 2 and item_lib.check_turn_in(e.trade, {item1 = 8279})) then -- Stack of Shift Reports
	...
	elseif(fac <= 4 and tonumber(qglobals.qeynos_badge5) == 4 and item_lib.check_turn_in(e.trade, {item1 = 8285, item2 = 8286})) then -- Marked Qeynos Badge of Honor and Closed Black Satchel
