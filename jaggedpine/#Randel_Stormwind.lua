...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.trade, {item1 = 9270, item2 = 9271, item3 = 9272, item4 = 9273})) then -- Head of Elishia Blackguard, Head of Reynold Blackguard, Head of Zed Sticklebush & Head of Vaurien Sticklebush
        ...
        e.other:Faction(1597,50); -- Residents of Jaggedpine
        e.other:Faction(272,25); -- Jaggedpine Treefolk
        e.other:Faction(302,25); -- Protectors of Pine
        e.other:Faction(262,5); -- Guards of Qeynos
        e.other:QuestReward(e.self,0,0,0,0,9226,1000); -- Sigil Ring of Jaggedpine
    end
