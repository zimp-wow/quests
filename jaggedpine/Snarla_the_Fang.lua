...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.trade, {item1 = 8199})) then -- Dryad Pate
        ...
        e.other:Faction(1598,20); -- Anchorites of Brell Serilis
        e.other:QuestReward(e.self,0,0,0,0,8270,1000); -- Token of Friendship
    elseif(item_lib.check_turn_in(e.trade, {item1 = 8270})) then -- Token of Friendship
    ...
    elseif(item_lib.check_turn_in(e.trade, {item1 = 9228})) then -- Sealed Wolf Fang Pouch
    ...
    elseif(item_lib.check_turn_in(e.trade, {item1 = 9229})) then -- Sealed Bear Fang Pouch
    ...
    elseif(item_lib.check_turn_in(e.trade, {item1 = 9230})) then -- Sealed Panther Fang Pouch
