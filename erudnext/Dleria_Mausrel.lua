...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 13922})) then
		...
		e.other:SummonItem(eq.ChooseRandom(2144,2146,2147,17005)); -- Item(s): Raw-hide Sleeves (2144), Raw-hide Gloves (2146), Raw-hide Leggings (2147), Backpack (17005)
		e.other:Ding();
		e.other:Faction(242,10,0); -- Faction: Deepwater Knights
		e.other:Faction(266,10,0); -- Faction: High Council of Erudin
