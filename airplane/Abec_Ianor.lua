...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 20958, item2 = 20749, item3 = 20750})) then					--wizard test of visualization using white-tipped spiroc feather, pulsating sapphire, amethyst amulet
		...
		e.self:Say("Excellent! Take this.");
		eq.depop();
	elseif(item_lib.check_turn_in(e.trade, {item1 = 20753, item2 = 20965, item3 = 20751, item4 = 20778})) then	--wizard test of preparation using efreeti war staff, lush nectar, copper air band, large sky sapphire (eye of the storm, 0.1 wt)
