...
function event_spawn(e)
	...
	if spawnID == 2625 then -- typeid 71009, grid 20 (3 points)
		eq.set_timer("caller", 1000);
	elseif spawnID == 2626 then -- typeid 71020, grid 21 (2 points)
		eq.set_timer("expulser", 1000);
	elseif spawnID == 2627 then -- typeid 71022, grid 22 (4 points)
