function event_say(e)
	...
	elseif(e.message:findi("not")) then
		e.self:Say("Are you blind " .. e.other:GetRaceName() .. "? It's Huge! Look at the claws on it! It is the bear that ate Dlemin.It's hungry too, just waiting for me to sleep.");
