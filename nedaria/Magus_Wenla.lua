...
function event_say(e)
	...
	elseif (e.message:findi("natimbi") and eq.get_data("god-open") and (tonumber(eq.get_data(e.other:AccountID() .. "-saryrn-flag")) > 0 or tonumber(eq.get_data(e.other:AccountID() .. "-kunark-flag")) >= 20)) then
