...
function event_say(e)
	...
	elseif(e.message:findi("truth")) then
		...
		e.other:SummonItem(31492); -- Item: Ghostly Bridle
		e.other:SummonItem(18474); -- Item: Scroll of the Burning Dead
		eq.depop();
	...
	elseif(e.message:findi("travel to felwithe")) then
		...
		e.other:SummonItem(31493); -- Item: Arrialla's Expended Token
	end
end
