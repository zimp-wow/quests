-- Skyshrine Velious Armor - Shadowknight
local quest_helper		= require('velious_quest_helper');
local SKYSHRINE_ARMOR	= quest_helper.SKYSHRINE_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(SKYSHRINE_ARMOR.Plate_Helmet,		31098),	-- Items: Blood Lord's Crown
	quest_helper:melee_chest(SKYSHRINE_ARMOR.Breastplate,		31099),	-- Items: Blood Lord's Breastplate
	quest_helper:melee_arms(SKYSHRINE_ARMOR.Plate_Vambraces,	31100),	-- Items: Blood Lord's Vambraces
	quest_helper:melee_bracer(SKYSHRINE_ARMOR.Plate_Bracer,		31101),	-- Items: Blood Lord's Bracer
	quest_helper:melee_gloves(SKYSHRINE_ARMOR.Plate_Gauntlets,	31102),	-- Items: Blood Lord's Gauntlets
	quest_helper:melee_legs(SKYSHRINE_ARMOR.Plate_Greaves,		31103),	-- Items: Blood Lord's Greaves
	quest_helper:melee_boots(SKYSHRINE_ARMOR.Plate_Boots,		31104)	-- Items: Blood Lord's Boots
};
