-- Skyshrine Velious Armor - Rogue
local quest_helper		= require('velious_quest_helper');
local SKYSHRINE_ARMOR	= quest_helper.SKYSHRINE_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(SKYSHRINE_ARMOR.Chain_Coif,		31126),	-- Items: Shadow Crown
	quest_helper:melee_chest(SKYSHRINE_ARMOR.Chain_Tunic,		31127),	-- Items: Shadow Chestguard
	quest_helper:melee_arms(SKYSHRINE_ARMOR.Chain_Sleeves,		31128),	-- Items: Shadow Vambraces
	quest_helper:melee_bracer(SKYSHRINE_ARMOR.Chain_Bracer,		31129),	-- Items: Shadow Bracer
	quest_helper:melee_gloves(SKYSHRINE_ARMOR.Chain_Gauntlets,	31130),	-- Items: Shadow Gauntlets
	quest_helper:melee_legs(SKYSHRINE_ARMOR.Chain_Leggings,		31131),	-- Items: Shadow Greaves
	quest_helper:melee_boots(SKYSHRINE_ARMOR.Chain_Boots,		31132)	-- Items: Shadow Boots
};
