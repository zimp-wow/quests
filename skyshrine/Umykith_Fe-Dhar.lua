-- Skyshrine Velious Armor - Bard
local quest_helper		= require('velious_quest_helper');
local SKYSHRINE_ARMOR	= quest_helper.SKYSHRINE_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(SKYSHRINE_ARMOR.Plate_Helmet,		31133),	-- Items: Helm of Twilight
	quest_helper:melee_chest(SKYSHRINE_ARMOR.Breastplate,		31134),	-- Items: Breastplate of Twilight
	quest_helper:melee_arms(SKYSHRINE_ARMOR.Plate_Vambraces,	31135),	-- Items: Vambraces of Twilight
	quest_helper:melee_bracer(SKYSHRINE_ARMOR.Plate_Bracer,		31136),	-- Items: Bracer of Twilight
	quest_helper:melee_gloves(SKYSHRINE_ARMOR.Plate_Gauntlets,	31137),	-- Items: Gauntlets of Twilight
	quest_helper:melee_legs(SKYSHRINE_ARMOR.Plate_Greaves,		31138),	-- Items: Greaves of Twilight
	quest_helper:melee_boots(SKYSHRINE_ARMOR.Plate_Boots,		31139)	-- Items: Boots of Twilight
};
