...
function event_enter(e)
    ...
    e.other:SendColoredText(0, "Aporia says, 'Come sit by the fire and relax! You will rest quickly here! Darksinga, quick, play us a tune!'")
    e.other:AddNimbusEffect(412)
end

function event_exit(e)
    e.other:DisableAreaRegens()
    e.other:SendColoredText(0, "The energy fades away as you leave the warmth of the fire.")
