...
sub GetRandomResult {
    ...
    my @rewards = (
        ...
        { chance => 10, items => [67923, 56052, 61036, 62774, 66783, 64711, 66431, 66449, 67953, 67883, 52193, 66598, 61979, 67145, 66564, 907290, 907291, 907292], message => "Nicely done! Pets love a facelift every now and then $name!" },
