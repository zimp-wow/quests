...
my @rewards = (
    ...
    { chance => 10, items => [67923, 56052, 61036, 62774, 66783, 64711, 66431, 66449, 67953, 67883, 52193, 66598, 61979, 67145, 66564], message => "Nicely done! Pets love a facelift every now and then \$name!" },
    ...
    { chance => 3, items => [976008], message => "Oooo! Your very own Clockwork Banker \$name!" },
    { chance => 3, items => [976009], message => "Your friends will be SO jealous! Congratulations on your Clockwork Merchant \$name!" },
...
sub GetRandomResult {
    ...
    foreach my $reward (@rewards) {
        ...
        if ($random_weight < $cumulative_weight) {
            quest::summonfixeditem(quest::ChooseRandom(@{$reward->{items}}));  # Choose a random item from the current reward
