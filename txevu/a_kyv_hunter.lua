function event_spawn(e)
	...
	e.self:ModSkillDmgTaken(7, -25); -- Skill: Archery
end
...
function event_timer(e)
	if e.timer == "casting" then
		...
		if hate_list ~= nil and roll >= 50 then
			e.self:Emote("releases a volley of arrows.");
			if tonumber(hate_list) == 1 then
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
			elseif tonumber(hate_list) == 2 then
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
			elseif tonumber(hate_list) == 3 then
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
			elseif tonumber(hate_list) == 4 then
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
			elseif tonumber(hate_list) == 5 then
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
			elseif tonumber(hate_list) == 6 then
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
				e.self:CastedSpellFinished(eq.ChooseRandom(4850, 4849, 4851), e.self:GetHateRandom())
