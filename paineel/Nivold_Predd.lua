...
function event_trade(e)
	...
	if e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.trade, {item1 = 16540, item2 = 13739, item3 = 14111, item4 = 14112}) then -- Item: Ice Giant Toes, Griffon Eye, Brain of the Ishva Mal, Powder of Reanimation
		...
		e.other:QuestReward(e.self,{exp = 1000, Copper = math.random(9), Silver = math.random(9), Gold = math.random(9), Platinum = math.random(4)});
		eq.unique_spawn(75164,0,0,474,1230,-37,256); -- NPC: avatar_of_dread
	else
