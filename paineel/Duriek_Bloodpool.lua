...
function event_say(e)
	if e.other:GetFaction(e.self) < 7 then
		...
		elseif e.message:findi("replacing") then
...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 18099}) then -- Item: Letter to Duriek
	...
	elseif item_lib.check_turn_in(e.trade, {item1 = 14365}) then -- Item: Cough Elixir
			...
			e.other:Faction(404,3); -- Faction: True Spirit
	elseif item_lib.check_turn_in(e.trade, {item1 = 14382}) then -- Item: Dusty Tome
			...
			e.other:Faction(404,3); -- Faction: True Spirit
	elseif charfaction >= 17 then
		if item_lib.check_turn_in(e.trade, {item1 = 5403,item2 = 11609,item3 = 5430,item4 = 14366}) then -- Items: Ghoulbane, Soul Leech, Dark Sword of Blood, Blade of Abrogation and Decrepit Sheath
			...
			e.other:Faction(404,3);		-- Faction: True Spirit
			e.other:SummonItem(14367);	-- Item: Corrupted Ghoulbane
