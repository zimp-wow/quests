function event_say(e)
	...
	elseif e.message:findi("gauntlet") then
		...
		e.other:SummonItem(19633); -- Item: Crude Gauntlet Mold
...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 20421}) then -- Item: Clan Kobok Blacksmith Traditions
		...
		e.other:SummonItem(20403);	-- Item: Dull Fell Blade Cutlass
		e.other:QuestReward(e.self,{exp = 50});
	elseif item_lib.check_turn_in(e.trade, {item1 = 20404, item2 = 20355, item3 = 20402}) then -- Items: Sharp Fell Blade Cutlass, Large Briar Snake Skin, Petrified Eyeball
		...
		e.other:SummonItem(20416);	-- Item: Fell Blade Cutlass
		e.other:QuestReward(e.self,{exp = 50});
	end
end
