function event_say(e)
	...
	elseif e.message:findi("clothing") then
		...
		e.self:Say("[abattoir initiate boots], [abattoir initiate sleeves], [abattoir initiate pantaloons], or [abattoir initiate robe]?");
	...
	elseif e.message:findi("pantaloon") then
		...
		e.other:SummonItem(19560); -- Item: Tattered Pantaloon Pattern
...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 20420}) then -- Item: Arcane Kobold Parchments
		...
		e.other:SummonItem(20358);	-- Item: Rough Abattoir Initiate Staff
		e.other:QuestReward(e.self,{exp = 100});
	elseif item_lib.check_turn_in(e.trade, {item1 = 20358, item2 = 20356, item3 = 20402}) then -- Items: Rough Abattoir Initiate Staff, Giant Briar Snake Skin, Petrified Eyeball
		...
		e.other:Faction(231,-1);	-- Faction: Craftkeepers
		e.other:Faction(233,-1);	-- Faction: Crimson Hands
		e.other:SummonItem(20418);	-- Item: Abattoir Initiate Staff
		e.other:QuestReward(e.self,{exp = 100});
	end
