...
function event_say(e)
	...
	elseif(e.message:findi("open the portal")) then
		e.self:Say("To beckon the Gatekeeper we must tempt him with bits of Doomfire. I have seen fragments of it leak through the cracks of the portal. It is here, in this place. Look around! Find the four bits and bring them to me. Ha ha! Hurry, hurry " .. e.other:Race() .. ". I cannot wait!");
	end
end
