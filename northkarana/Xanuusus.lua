...
function event_trade(e)
  ...
  if ( e.other:HasClass(Class.RANGER) and qglobals["ranger_epic15_pre"] ~= nil) then
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 20483,item2 = 20484})) then
		...
		e.other:SummonFixedItem(2020488); -- earthcaller
		e.other:Ding();
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 20699,item2 = 20697,item3 = 20698,item4 = 20440})) then
		...
		e.other:SummonFixedItem(2020490); -- naturewalker's scimitar
		e.other:Ding();
		e.other:AddEXP(2500000);
