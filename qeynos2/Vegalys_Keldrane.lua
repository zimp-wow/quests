...
-- 3 = Handed Stack of Shift Reports to Sergeant Caelin
-- 4 = Handed Orders for Sergeant Caelin to Caelin
-- 5 = Handed Marked Qeynos Badge of Honor and Closed Black Satchel to Caelin and Received the final Qeynos Badge of Nobility
...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 2173}) then -- Item: Cracked Corrupt Guard Helm
		...
		e.other:SummonItem(18289);					-- Item: Investigator's Briefing
		...
		e.other:Faction(273,-1,0);					-- Faction: Kane Bayle
		e.other:Faction(291,1,0);					-- Faction: Merchants of Qeynos
		eq.set_global("qeynos_badge1","1",5,"F");	-- QGlobal: Badge Globals
	elseif item_lib.check_turn_in(e.trade, {item1 = 2386}) then -- Item: Investigator's Badge
		...
		e.other:QuestReward(e.self,{exp = 2000});
		e.other:SummonItem(18292);					-- Item: Interrogator's Briefing
		eq.set_global("qeynos_badge2","1",5,"F");	-- QGlobal: Badge Globals
	elseif item_lib.check_turn_in(e.trade, {item1 = 2583}) then -- Item: Researcher's Badge
		...
		e.other:QuestReward(e.self,{exp = 2000});
		e.other:SummonItem(2694);					-- Item: Seal of Vegalys
		eq.set_global("qeynos_badge4","1",5,"F");	-- QGlobal: Badge Globals
	elseif item_lib.check_turn_in(e.trade, {item1 = 2694, item2 = 2392 }) then -- Items: Seal of Vegalys and Head of Azibelle Spavin
		...
		e.other:SummonItem(2388);					-- Item: Qeynos Badge of Honor
		eq.set_global("qeynos_badge4","4",5,"F");	-- QGlobal: Badge Globals
	end
