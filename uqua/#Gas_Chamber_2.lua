...
function event_spawn(e)
	...
	started = false;
	completed = qglobals[instance_id.. '_gaschmb2complete'] ~= nil
	count = 0;
...
function event_timer(e)
	...
	if e.timer == "gaschamber" then
		...
		if rand_emote == 1 then
			...
			eq.set_global(instance_id.."_gaschmb2","67707",3,"M5");
		elseif rand_emote == 2 then
			...
			eq.set_global(instance_id.."_gaschmb2","67708",3,"M5");
		elseif rand_emote == 3 then
			...
			eq.set_global(instance_id.."_gaschmb2","67709",3,"M5");
