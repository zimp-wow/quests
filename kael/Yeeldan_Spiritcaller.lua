-- Kael Velious Armor - Shaman
local quest_helper	= require('velious_quest_helper');
local KAEL_ARMOR	= quest_helper.KAEL_ARMOR;

local QUEST_ITEMS = {
	quest_helper:priest_helmet(KAEL_ARMOR.Chain_Coif,		25356),	-- Item: Spirit Caller's Helm
	quest_helper:priest_chest(KAEL_ARMOR.Chain_Tunic,		25357),	-- Item: Spirit Caller's Breastplate
	quest_helper:priest_arms(KAEL_ARMOR.Chain_Sleeves,		25358),	-- Item: Spirit Caller's Vambraces
	quest_helper:priest_bracer(KAEL_ARMOR.Chain_Bracer,		25359),	-- Item: Spirit Caller's Bracer
	quest_helper:priest_gloves(KAEL_ARMOR.Chain_Gauntlets,	25360),	-- Item: Spirit Caller's Gauntlets
	quest_helper:priest_legs(KAEL_ARMOR.Chain_Leggings,		25361),	-- Item: Spirit Caller's Greaves
	quest_helper:priest_boots(KAEL_ARMOR.Chain_Boots,		25362)	-- Item: Spirit Caller's Boots
};
