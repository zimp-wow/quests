-- Kael Velious Armor - Paladin
local quest_helper	= require('velious_quest_helper');
local KAEL_ARMOR	= quest_helper.KAEL_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(KAEL_ARMOR.Plate_Helmet,		25370),	-- Item: Shining Helm
	quest_helper:melee_chest(KAEL_ARMOR.Breastplate,		25371),	-- Item: Shining Breastplate
	quest_helper:melee_arms(KAEL_ARMOR.Plate_Vambraces,		25372),	-- Item: Shining Vambraces
	quest_helper:melee_bracer(KAEL_ARMOR.Plate_Bracer,		25373),	-- Item: Shining Bracer
	quest_helper:melee_gloves(KAEL_ARMOR.Plate_Gauntlets,	25374),	-- Item: Shining Gauntlets
	quest_helper:melee_legs(KAEL_ARMOR.Plate_Greaves,		25375), -- Item: Shining Greaves
	quest_helper:melee_boots(KAEL_ARMOR.Plate_Boots,		25376)	-- Item: Shining Boots
};
