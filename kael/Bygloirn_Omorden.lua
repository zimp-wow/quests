-- Kael Velious Armor - Bard
local quest_helper	= require('velious_quest_helper');
local KAEL_ARMOR	= quest_helper.KAEL_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(KAEL_ARMOR.Plate_Helmet,		25384),	-- Item: Troubadour's Helm
	quest_helper:melee_chest(KAEL_ARMOR.Breastplate,		25385),	-- Item: Troubadour's Breastplate
	quest_helper:melee_arms(KAEL_ARMOR.Plate_Vambraces,		25386),	-- Item: Troubadour's Vambraces
	quest_helper:melee_bracer(KAEL_ARMOR.Plate_Bracer,		25387),	-- Item: Troubadour's Bracer
	quest_helper:melee_gloves(KAEL_ARMOR.Plate_Gauntlets,	25388),	-- Item: Troubadour's Gauntlets
	quest_helper:melee_legs(KAEL_ARMOR.Plate_Greaves,		25389),	-- Item: Troubadour's Greaves
	quest_helper:melee_boots(KAEL_ARMOR.Plate_Boots,		25390)	-- Item: Troubadour's Boots
};
