-- Kael Velious Armor - Shadowknight
local quest_helper	= require('velious_quest_helper');
local KAEL_ARMOR	= quest_helper.KAEL_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(KAEL_ARMOR.Plate_Helmet,		25349),	-- Item: Malevolent Crown
	quest_helper:melee_chest(KAEL_ARMOR.Breastplate,		25350),	-- Item: Malevolent Breastplate
	quest_helper:melee_arms(KAEL_ARMOR.Plate_Vambraces,		25351),	-- Item: Malevolent Vambraces
	quest_helper:melee_bracer(KAEL_ARMOR.Plate_Bracer,		25352),	-- Item: Malevolent Bracer
	quest_helper:melee_gloves(KAEL_ARMOR.Plate_Gauntlets,	25353),	-- Item: Malevolent Gauntlets
	quest_helper:melee_legs(KAEL_ARMOR.Plate_Greaves,		25354),	-- Item: Malevolent Greaves
	quest_helper:melee_boots(KAEL_ARMOR.Plate_Boots,		25355)	-- Item: Malevolent Boots
};
