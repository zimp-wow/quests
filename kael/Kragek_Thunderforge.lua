-- Kael Velious Armor - Warrior
local quest_helper	= require('velious_quest_helper');
local KAEL_ARMOR	= quest_helper.KAEL_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(KAEL_ARMOR.Plate_Helmet,		25433),	-- Item: Warlord's Crown
	quest_helper:melee_chest(KAEL_ARMOR.Breastplate,		25434),	-- Item: Warlord's Breastplate
	quest_helper:melee_arms(KAEL_ARMOR.Plate_Vambraces,		25435),	-- Item: Warlord's Vambraces
	quest_helper:melee_bracer(KAEL_ARMOR.Plate_Bracer,		25436),	-- Item: Warlord's Bracer
	quest_helper:melee_gloves(KAEL_ARMOR.Plate_Gauntlets,	25437),	-- Item: Warlord's Gauntlets
	quest_helper:melee_legs(KAEL_ARMOR.Plate_Greaves,		25438),	-- Item: Warlord's Greaves
	quest_helper:melee_boots(KAEL_ARMOR.Plate_Boots,		25439)	-- Item: Warlord's Boots
};
