-- Kael Velious Armor - Beastlord
local quest_helper	= require('velious_quest_helper');
local KAEL_ARMOR	= quest_helper.KAEL_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(KAEL_ARMOR.Leather_Cap,		5439),	-- Item: Crown of Beast Mastery
	quest_helper:melee_chest(KAEL_ARMOR.Leather_Tunic,		5440),	-- Item: Chestguard of Beast Mastery
	quest_helper:melee_arms(KAEL_ARMOR.Leather_Sleeves,		5441),	-- Item: Armband of Beast Mastery
	quest_helper:melee_bracer(KAEL_ARMOR.Leather_Bracelet,	5442),	-- Item: Bracer of Beast Mastery
	quest_helper:melee_gloves(KAEL_ARMOR.Leather_Gloves,	5443),	-- Item: Gloves of Beast Mastery
	quest_helper:melee_legs(KAEL_ARMOR.Leather_Leggings,	5444),	-- Item: Leggings of Beast Mastery
	quest_helper:melee_boots(KAEL_ARMOR.Leather_Boots,		5445)	-- Item: Boots of Beast Mastery
};
