...
function event_say(e)
	...
	elseif(e.message:findi("second beast") and qglobals["shaman_epic"] == "3") then
		e.self:Say("The second creature is a strange and powerful beast that seeks to increase the number of its followers by overcoming them with intimidation. I am embarrassed to say that he had [" .. eq.say_link("stolen") .. "] a special gift from me -- a gift given to me by the elder spirits when I had proven my dedication and worth.");
