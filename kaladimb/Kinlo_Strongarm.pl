...
sub EVENT_ITEM {
  if ($faction <= 5) { #indifferent or better
    if (plugin::check_handin(\%itemcount, 5664 => 1)) {
      ...
      quest::summonfixeditem(20455); # Item: Enchanted Clay
    }
      ...
      quest::summonfixeditem(20478); # Item: Soulbound Hammer
    }
      ...
      quest::summonfixeditem(20482); # Item: Small bit of Mithril Ore
      quest::spawn2(67089,0,0,-189.5,346.8,1.8,69); # NPC: Usbak_the_Old
    }
      ...
      quest::summonfixeditem(20483); # Item: Refined Mithril Blade
    }
  }
