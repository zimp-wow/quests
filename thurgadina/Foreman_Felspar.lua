...
local QUEST_ITEMS = {
	quest_helper:melee_boots(THURG_ARMOR.Chain_Boots,		31034),	-- Items: Brigand's Boots
	quest_helper:melee_legs(THURG_ARMOR.Chain_Leggings,		31033),	-- Items: Brigand's Greaves
	quest_helper:melee_gloves(THURG_ARMOR.Chain_Gauntlets,	31032),	-- Items: Brigand's Gauntlets
	quest_helper:melee_bracer(THURG_ARMOR.Chain_Bracer,		31031),	-- Items: Brigand's Bracer
	quest_helper:melee_arms(THURG_ARMOR.Chain_Sleeves,		31030),	-- Items: Brigand's Vambraces
	quest_helper:melee_chest(THURG_ARMOR.Chain_Tunic,		31029),	-- Items: Brigand's Chestguard
	quest_helper:melee_helmet(THURG_ARMOR.Chain_Coif,		31028)	-- Items: Brigand's Circlet
};
