-- Thurg Velious Armor - Monk
local quest_helper	= require('velious_quest_helper');
local THURG_ARMOR	= quest_helper.THURG_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(THURG_ARMOR.Leather_Cap,		31091),	-- Items: Grand Master's Headband
	quest_helper:melee_boots(THURG_ARMOR.Leather_Boots,		31097),	-- Items: Grand Master's Slippers
	quest_helper:melee_chest(THURG_ARMOR.Leather_Tunic,		31092),	-- Items: Grand Master's Chest Wraps
	quest_helper:melee_arms(THURG_ARMOR.Leather_Sleeves,	31093),	-- Items: Grand Master's Arm Wraps
	quest_helper:melee_gloves(THURG_ARMOR.Leather_Gloves,	31095),	-- Items: Fist of the Grand Master
	quest_helper:melee_bracer(THURG_ARMOR.Leather_Bracelet,	31094),	-- Items: Grand Master's Wrist Wraps
	quest_helper:melee_legs(THURG_ARMOR.Leather_Leggings,	31096)	-- Items: Grand Master's Leg Wraps
};
