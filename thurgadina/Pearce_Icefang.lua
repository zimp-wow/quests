-- Thurg Velious Armor - Beastlord
local quest_helper	= require('velious_quest_helper');
local THURG_ARMOR	= quest_helper.THURG_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(THURG_ARMOR.Leather_Cap,		5453),	-- Items: Crown of the Beastlord
	quest_helper:melee_chest(THURG_ARMOR.Leather_Tunic,		5454),	-- Items: Chestguard of the Beastlord
	quest_helper:melee_arms(THURG_ARMOR.Leather_Sleeves,	5455),	-- Items: Armband of the Beastlord
	quest_helper:melee_bracer(THURG_ARMOR.Leather_Bracelet,	5456),	-- Items: Bracer of the Beastlord
	quest_helper:melee_gloves(THURG_ARMOR.Leather_Gloves,	5457),	-- Items: Gloves of the Beastlord
	quest_helper:melee_legs(THURG_ARMOR.Leather_Leggings,	5458),	-- Items: Leggings of the Beastlord
	quest_helper:melee_boots(THURG_ARMOR.Leather_Boots,		5459)	-- Items: Boots of the Beastlord
};
...
function event_say(e)
	if e.other:GetFaction(e.self) <= 3  then -- Warmly or better
		if e.message:findi("hail") then
			...
			e.self:Say("Greetings. I only wish to speak to a beastlord. Are you a ["..eq.say_link("I am a Beastlord",false,"Beastlord").."]?");
