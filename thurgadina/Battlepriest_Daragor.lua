...
local QUEST_ITEMS = {
	quest_helper:melee_boots(THURG_ARMOR.Plate_Boots,		31027),	-- Items: Runed Protector's Boots
	quest_helper:melee_legs(THURG_ARMOR.Plate_Greaves,		31026),	-- Items: Runed Protector's Greaves
	quest_helper:melee_gloves(THURG_ARMOR.Plate_Gauntlets,	31025),	-- Items: Runed Protector's Gauntlets
	quest_helper:melee_bracer(THURG_ARMOR.Plate_Bracer,		31024),	-- Items: Runed Protector's Bracer
	quest_helper:melee_arms(THURG_ARMOR.Plate_Vambraces,	31023),	-- Items: Runed Protector's Vambraces
	quest_helper:melee_chest(THURG_ARMOR.Plate_Breastplate,	31022),	-- Items: Runed Protector's Breastplate
	quest_helper:melee_helmet(THURG_ARMOR.Plate_Helmet,		31021)	-- Items: Runed Protector's Helm
};
