-- Thurg Velious Armor - Bard
local quest_helper	= require('velious_quest_helper');
local THURG_ARMOR	= quest_helper.THURG_ARMOR;

local QUEST_ITEMS = {
    quest_helper:melee_boots(THURG_ARMOR.Plate_Boots,		31041),	-- Items: Resonant Boots
    quest_helper:melee_legs(THURG_ARMOR.Plate_Greaves,		31040),	-- Items: Resonant Greaves
    quest_helper:melee_gloves(THURG_ARMOR.Plate_Gauntlets,	31039),	-- Items: Resonant Gauntlets
    quest_helper:melee_bracer(THURG_ARMOR.Plate_Bracer,		31038),	-- Items: Resonant Bracer
    quest_helper:melee_arms(THURG_ARMOR.Plate_Vambraces,	31037),	-- Items: Resonant Vambraces
    quest_helper:melee_chest(THURG_ARMOR.Plate_Breastplate,	31036),	-- Items: Resonant Breastplate
    quest_helper:melee_helmet(THURG_ARMOR.Plate_Helmet,		31035)	-- Items: Resonant Helm
};
