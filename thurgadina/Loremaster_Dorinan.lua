-- Thurg Velious Armor - Cleric
local quest_helper	= require('velious_quest_helper');
local THURG_ARMOR	= quest_helper.THURG_ARMOR;

local QUEST_ITEMS = {
    quest_helper:priest_boots(THURG_ARMOR.Plate_Boots,		31048),	-- Items: Boots of Forbidden Rites
    quest_helper:priest_legs(THURG_ARMOR.Plate_Greaves,		31047),	-- Items: Greaves of Forbidden Rites
    quest_helper:priest_gloves(THURG_ARMOR.Plate_Gauntlets,	31046),	-- Items: Gauntlets of Forbidden Rites
    quest_helper:priest_bracer(THURG_ARMOR.Plate_Bracer,	31045),	-- Items: Bracers of Forbidden Rites
    quest_helper:priest_arms(THURG_ARMOR.Plate_Vambraces,	31044),	-- Items: Vambraces of Forbidden Rites
    quest_helper:priest_chest(THURG_ARMOR.Breastplate,		31043),	-- Items: Breastplate of Forbidden Rites
    quest_helper:priest_helmet(THURG_ARMOR.Plate_Helmet,	31042)	-- Items: Crown of Forbidden Rites
};
...
function event_say(e)
	if e.other:GetFaction(e.self) <= 3  then -- Warmly or better
		...
		elseif e.message:findi("cleric") then
			e.self:Say("Ah, a most pious one indeed. I sense the aura of your devotion and conviction and they are strong about you. A shame you are so short-lived. But I see potential in you and for that I shall aid you in your calling, cleric. Do you [" .. eq.say_link("i wish your aid",false,"wish my aid") .. "]?");
