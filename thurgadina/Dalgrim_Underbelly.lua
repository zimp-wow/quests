-- Thurg Velious Armor - Shadowknight
local quest_helper	= require('velious_quest_helper');
local THURG_ARMOR	= quest_helper.THURG_ARMOR;

local QUEST_ITEMS = {
	quest_helper:melee_helmet(THURG_ARMOR.Plate_Helmet,		31000),	-- Items: Dark Runed Crown
	quest_helper:melee_chest(THURG_ARMOR.Breastplate,		31001),	-- Items: Dark Runed Breastplate
	quest_helper:melee_arms(THURG_ARMOR.Plate_Vambraces,	31002),	-- Items: Dark Runed Vambraces
	quest_helper:melee_bracer(THURG_ARMOR.Plate_Bracer,		31003),	-- Items: Dark Runed Bracer
	quest_helper:melee_gloves(THURG_ARMOR.Plate_Gauntlets,	31004),	-- Items: Dark Runed Gauntlets
	quest_helper:melee_legs(THURG_ARMOR.Plate_Greaves,		31005),	-- Items: Dark Runed Greaves
	quest_helper:melee_boots(THURG_ARMOR.Plate_Boots,		31006)	-- Items: Dark Runed Boots
};
