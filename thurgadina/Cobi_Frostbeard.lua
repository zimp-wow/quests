-- Thurg Velious Armor - Druid
local quest_helper	= require('velious_quest_helper');
local THURG_ARMOR	= quest_helper.THURG_ARMOR;

local QUEST_ITEMS = {
	quest_helper:priest_helmet(THURG_ARMOR.Leather_Cap,			31049),	-- Items: Rowyl's Circlet of Nature
	quest_helper:priest_boots(THURG_ARMOR.Leather_Boots,		31055),	-- Items: Rowyl's Boots of Nature
	quest_helper:priest_chest(THURG_ARMOR.Leather_Tunic,		31050),	-- Items: Rowyl's Chestguard of Nature
	quest_helper:priest_arms(THURG_ARMOR.Leather_Sleeves,		31051),	-- Items: Rowyl's Vambraces of Nature
	quest_helper:priest_gloves(THURG_ARMOR.Leather_Gloves,		31053),	-- Items: Rowyl's Gauntlets of Nature
	quest_helper:priest_bracer(THURG_ARMOR.Leather_Bracelet,	31052),	-- Items: Rowyl's Bracer of Nature
	quest_helper:priest_legs(THURG_ARMOR.Leather_Leggings,		31054)	-- Items: Rowyl's Greaves of Nature
};
