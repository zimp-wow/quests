...
function event_trade(e)
    ...
    if(e.other:HasClass(Class.ENCHANTER) and item_lib.check_turn_in(e.trade, {item1 = 54025})) then -- Swirling Vial
    ...
    elseif(item_lib.check_turn_in(e.trade, {item1 = 16506, item2 = 54006, item3 = 54006}) and e.other:HasClass(Class.ENCHANTER) ) then -- Enchanted Gold Bar, 2x Gleaming Zraxthril Ores
