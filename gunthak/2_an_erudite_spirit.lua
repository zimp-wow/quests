...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 59027})) then -- Black Skull Necklace
		...
		e.other:QuestReward(e.self,0,0,0,0,59003,eq.ExpHelper(45, 5)); -- Spell: Ethereal Cleansing
		e.other:SummonItem(59028); -- Glowing Black Skull Necklace
