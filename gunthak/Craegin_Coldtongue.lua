function event_say(e)
    ...
    if(e.other:GetClass() == Class.BEASTLORD) then
        ...
        elseif(e.message:findi("draw more about your warder")) then
            ...
            e.other:SummonItem(59032); -- Stone Emblem
...
function event_trade(e)
    ...
    if(e.other:GetClass() == Class.BEASTLORD and item_lib.check_turn_in(e.self, e.trade, {item1 = 59033})) then -- Glowing Collar
        ...
        e.other:QuestReward(e.self,0,0,0,0,59010,eq.ExpHelper(51)); -- Spell: Bond of the Wild
    elseif(e.other:GetClass() == Class.BEASTLORD and item_lib.check_turn_in(e.self, e.trade, {item1 = 59034})) then -- Strange Dark Powder
        ...
        e.other:QuestReward(e.self,0,0,0,0,59009,eq.ExpHelper(39)); -- Spell: Malaria
    end
