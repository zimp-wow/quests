...
function event_trade(e)
    ...
    if(e.other:HasClass(Class.BEASTLORD) and item_lib.check_turn_in(e.trade, {item1 = 59033})) then -- Glowing Collar
    ...
    elseif(e.other:HasClass(Class.BEASTLORD) and item_lib.check_turn_in(e.trade, {item1 = 59034})) then -- Strange Dark Powder
