...
function event_trade(e)
    ...
    if(e.other:HasClass(Class.RANGER) and item_lib.check_turn_in(e.trade, {item1 = 59038, item2 = 59039})) then -- Captured Nifilik and Tiny Nifilik
    ...
    elseif(e.other:HasClass(Class.RANGER) and item_lib.check_turn_in(e.trade, {item1 = 59040})) then -- Glowing Zraxthril Amulet
