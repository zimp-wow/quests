...
function event_say(e)
    if(e.other:GetClass() == Class.RANGER) then -- Ranger
...
function event_trade(e)
    ...
    if(e.other:GetClass() == Class.RANGER and item_lib.check_turn_in(e.self, e.trade, {item1 = 59038, item2 = 59039})) then -- Captured Nifilik and Tiny Nifilik
        ...
        e.other:QuestReward(e.self,0,0,0,0,59007,eq.ExpHelper(44)); -- Spell: Swarm of Pain
    
    elseif(e.other:GetClass() == Class.RANGER and item_lib.check_turn_in(e.self, e.trade, {item1 = 59040})) then -- Glowing Zraxthril Amulet
        ...
        e.other:SummonItem(59041); -- Cracked Zraxthril Amulet
