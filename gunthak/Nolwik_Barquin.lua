...
function event_trade(e)
    ...
    if(e.other:HasClass(Class.DRUID) and item_lib.check_turn_in(e.trade, {item1 = 59061, item2 = 59062})) then -- Golden Emblem (Symbol of Tunare) and Golden Emblem (Symbol of Karana)
