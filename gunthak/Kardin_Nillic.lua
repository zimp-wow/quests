-- Kardin Nillic in Gunthak for bard song quest
...
function event_say(e)
    if(e.other:HasClass(Class.BARD)) then -- Bard
        ...
        e.self:Emote("looks up at you and says in a hushed voice. 'Please be quiet. My friend is very ill and loud noises seem to cause him even more pain. I fear he will die soon. Please allow his final moments to pass in relative peace.' ");
    end
end
