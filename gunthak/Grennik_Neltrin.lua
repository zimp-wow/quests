...
function event_say(e)
    if(e.other:GetClass() == Class.CLERIC or e.other:GetClass() == Class.DRUID or e.other:GetClass() == Class.SHAMAN) then
...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 59053})) then -- Glowing Black Potion
        ...
        if(e.other:GetClass() == Class.SHAMAN) then
            e.other:QuestReward(e.self,0,0,0,0,59525,eq.ExpHelper(51)); -- Spell: Blood of Nadox
        elseif(e.other:GetClass() == Class.CLERIC or e.other:GetClass() == Class.DRUID) then
