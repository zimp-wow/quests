...
sub EVENT_SAY {
  if($text=~/Hail/i) {
    quest::emote("glances over from his books for a moment. 'Greetings. Have you come to the realm of the tranquil to study as have? The chaotic energy of lightning has caught my interest of late. I've been trying to understand the magics that further refine my control of lightning and [" . quest::saylink("thunder") . "].");
  }
  if($text=~/thunder/i) {
