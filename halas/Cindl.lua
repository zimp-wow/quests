...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 13761})) then
		...
		e.other:SummonItem(eq.ChooseRandom(2131, 2134, 2127, 2126, 2129, 2125, 2133)); -- Item(s): Large Tattered Belt (2131)
		e.other:Ding();
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 12223, item2 = 12223})) then
		...
		e.other:SummonItem(eq.ChooseRandom(2034, 2171, 2164)); -- Item(s): Large Leather Gloves (2034)
		e.other:Ding();
		e.other:Faction(328, 5); -- Faction: Merchants of Halas
		e.other:Faction(320, 5); -- Faction: Wolves of the North
		e.other:Faction(327, 5); -- Faction: Shamen of Justice
