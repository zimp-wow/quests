...
sub EVENT_SAY {
  ...
  if ($text=~/helm/i) {
    ...
    quest::summonitem(55111); # Item: Northern Wolf Helm Mold
  }
  if ($text=~/bracers/i) {
    ...
    quest::summonitem(55112); # Item: Northern Wolf Bracer Mold
  }
  if ($text=~/armplates/i) {
    ...
    quest::summonitem(55113); # Item: Northern Wolf Armplate Mold
  }
  if ($text=~/boots/i) {
    ...
    quest::summonitem(55114); # Item: Northern Wolf Boot Mold
  }
  if ($text=~/legplates/i) {
    ...
    quest::summonitem(55115); # Item: Northern Wolf Legplate Mold
  }
  if ($text=~/gauntlets/i) {
