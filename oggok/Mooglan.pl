...
sub EVENT_SAY {
  ...
  if ($text=~/helm/i) {
    ...
    quest::summonitem(51370); # Item: Helm Mold of Darkness
  }
  if ($text=~/bracer/i) {
    ...
    quest::summonitem(51372); # Item: Bracer Mold of Darkness
  }
  if ($text=~/sleeves/i) {
    ...
    quest::summonitem(51371); # Item: Armplate Mold of Darkness
  }
  if ($text=~/boots/i) {
    ...
    quest::summonitem(51374); # Item: Boot Mold of Darkness
  }
  if ($text=~/legplates/i) {
    ...
    quest::summonitem(51375); # Item: Legplate Mold of Darkness
  }
  if ($text=~/gloves/i) {
    ...
    quest::summonitem(51373); # Item: Gauntlet Mold of Darkness
  }
  if ($text=~/breastplate/i) {
    ...
    quest::summonitem(51376); # Item: Breastplate Mold of Darkness
  }
  if ($text=~/trust/i) {
