...
function event_say(e)
	...
	elseif(e.message:findi("ready")) then
		...
		e.other:SummonFixedItem(20532); -- Item: Torch of Misty
	end
end
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 20379})) then
		...
		e.other:SummonFixedItem(20376); -- Item: Maestro's Symphony Page 24 Top
		e.other:Ding();
		e.other:AddEXP(1000);
	elseif(item_lib.check_turn_in(e.trade, {item1 = 20366})) then
		...
		e.other:SummonFixedItem(20383); -- Item: Maestro's Symphony Page 24 Bottom
		e.other:Ding();
		e.other:AddEXP(1000);
	end
