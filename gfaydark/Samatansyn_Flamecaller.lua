function event_say(e)
	...
	elseif e.message:findi("coif") then
		...
		e.other:SummonItem(22671); -- Item: Enchanted Coif Pattern
...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 27539,item2 = 13266,item3 = 13266}) then -- Faydark Champions Long Sword, from Cb Cell Key
		...
		e.other:SummonItem(27532);	-- Item: Faydark Champions Long Sword
	end
