...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 13035}) then
		...
		e.other:QuestReward(e.self,{exp = 150});
	elseif item_lib.check_turn_in(e.trade, {item1 = 13347,item2 = 13349,item3 = 13348,item4 = 13350}) then
		...
		e.other:Faction(226,10); -- Faction: Clerics of Tunare
		e.other:Faction(279,10); -- Faction: King Tearis Thex
		e.other:Faction(5001,7); -- Faction: Anti-mage
	end
