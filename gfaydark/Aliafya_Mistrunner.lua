...
function event_say(e)
	if e.message:findi("hail") then
		e.self:Say("Pleased to meet you, " .. e.other:GetName() .. ", I am Aliafya Mistrunner Preserver of Nature and loyal servant of Tunare. I have resided in this guild house for many of my years. I pride myself on being a mentor to many young druids of Tunare that come up through our ranks. If you are a [druid of Tunare] then I might have some work for you.");
	elseif e.message:findi("druid of Tunare") then
		e.self:Say("I am always pleased to see new faces amongst us indeed " .. e.other:GetName() .. ". However, I must learn if you are loyal to your house and your god by asking you to complete a series of training exercises. These tests will enable you to learn your way around this great land we call home and to pick up some very valuable hunting skills that will aid you in all of your battles to come. When you are [ready to begin your training] I will present you with your Leafrunners Assembly Kit.");
	elseif e.message:findi("ready to begin") then
		e.other:SummonItem(17366);
		e.self:Say("Here is your Leafrunners Assembly Kit, " .. e.other:GetName() .. ". In this kit you will place a number of [magical components] that will be infused together to create armor materials used to crafting Leafrunners Leather Armor. Once you have created the armor materials you will then take them to a loom along with the correct pattern to fashion together your armor piece.");
	...
	elseif e.message:findi("boots") then
		e.other:SummonItem(22674); -- An Enchanted Boots Pattern
	...
	elseif e.message:findi("bracers") then
		e.other:SummonItem(22672); -- An Enchanted Bracer Pattern
	...
	elseif e.message:findi("caps") then
		e.other:SummonItem(22628); -- An Enchanted Cap Pattern
	...
	elseif e.message:findi("gloves") then
		e.other:SummonItem(22633); -- An Enchanted Gloves Pattern
	...
	elseif e.message:findi("leggings") then
		e.other:SummonItem(27570); -- An Enchanted Leggings Pattern
	...
	elseif e.message:findi("sleeves") then
		e.other:SummonItem(22631); -- An Enchanted Sleeves Pattern
	...
	elseif e.message:findi("tunics") then
		e.other:SummonItem(22677); -- An Enchanted Tunic Pattern
