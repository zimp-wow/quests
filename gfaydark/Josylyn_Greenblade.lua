...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 20281}) then -- Item: Orcish Arsons Torch
		e.self:Say("Good work, " .. e.other:GetName() .. "! Take this Dull Emerald Novice Sword and sharpen it in a forge with a sharpening stone. It may take you several attempts if you are not familiar with the process. Once that is accomplished, bring me the Sharp Emerald Novice Sword, a Pristine Forest Drakeling Scales, and an Arborean Amber. I will put the finishing touches on the sword.'")
		e.other:QuestReward(e.self,{exp = 200});
		e.other:SummonItem(20294);	-- Item: Dull Emerald Novice Sword
		e.other:Faction(326,5);		-- Faction: Emerald Warriors
		e.other:Faction(270,-5);	-- Faction: Indigo Brotherhood
		e.other:Faction(325,1);		-- Faction: Merchants of Felwithe
		e.other:Faction(276,1);		-- Faction: Kelethin Merchants
	elseif item_lib.check_turn_in(e.trade, {item1 = 20298,item2 = 20274,item3 = 20271}) then -- Items: Sharp Emerald Novice Sword, Arborean Amber, Pristine Forest Drakeling Scales
		e.self:Emote(" fashions a grip out of the pristine forest drakeling scales, fastens the arborean amber to the pommel of the weapon, and polishes the blade with a luminescent substance. 'Here is your new weapon, brave Emerald Warrior. May it serve you well.'")
		e.other:QuestReward(e.self,{exp = 300});
		e.other:SummonItem(20331);	-- Item: Dull Emerald Novice Long Sword
		e.other:Faction(326,5);		-- Faction: Emerald Warriors
		e.other:Faction(270,-5);	-- Faction: Indigo Brotherhood
		e.other:Faction(325,1);		-- Faction: Merchants of Felwithe
		e.other:Faction(276,1);		-- Faction: Kelethin Merchants
